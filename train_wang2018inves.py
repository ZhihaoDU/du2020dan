...
if __name__ == '__main__':
    ...
    parser.add_argument('--dist_alpha', type=float, default=0.005)
    parser.add_argument('--adversarial_loss', type=str, default="lsgangp")
    ...
    for epoch in range(args.total_epoch):
        if epoch > 0 or train_first:
            ...
            for iteration, (clean_frame, noisy_frame, frame_number, batch_mask) in enumerate(train_dataloader):
                ...
                # train the generator twice and the discriminator once.
                if global_step % 2 == 0:
