...
class MelClcnn(nn.Module):

    def __init__(self, opts):
        super(MelClcnn, self).__init__()
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.Conv2d(ngf * 2, ngf * 2, (3, 3), (1, 1), (1, 1), (1, 1)),
            nn.BatchNorm2d(ngf * 2),
            nn.LeakyReLU(0.2),
        ...
        self.deconv2 = nn.Sequential(
            nn.ConvTranspose2d(ngf * 2 * 2, ngf *2, (3, 3), (1, 1), (1, 1), dilation=(1, 1)),
            nn.BatchNorm2d(ngf * 2),
            nn.LeakyReLU(0.2),

            nn.ConvTranspose2d(ngf * 2, ngf * 2, (3, 3), (1, 1), (1, 1), dilation=(1, 1)),
            nn.BatchNorm2d(ngf * 2),
            nn.LeakyReLU(0.2),
        ...
        self.deconv3 = nn.Sequential(
            ...
            nn.ConvTranspose2d(ngf * 1 * 2, ngf * 1, (3, 3), (1, 1), (1, 1), dilation=(1, 1)),
            nn.BatchNorm2d(ngf),
            nn.LeakyReLU(0.2),
    ...
    def forward(self, x):
        ...
        lstm_out = self.fc(lstm_out.contiguous().view(bb * tt, self.hidden_units))
