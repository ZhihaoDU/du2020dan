...
if __name__ == '__main__':
    ...
    parser.add_argument('--disc_name', type=str, default=None) # default mel_lsgan_rgp_DCGAN64c128d_mask_irm_early50_5dpg
    parser.add_argument('--disc_step', type=int, default=0) # default 57534
